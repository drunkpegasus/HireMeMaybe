    ...
    <>
      <NextSeo
        ...
        openGraph={{
          ...
          title: "Learn About Kaustubh - Software Developer",
          description:
            "Dive into the story of Kaustubh, a Software Developer. Uncover the experiences, skills, and passion that fuel a commitment to delivering exceptional web solutions.",
          images: [
            {
