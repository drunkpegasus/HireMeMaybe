...
export const getStaticProps: GetStaticProps<{ images: ImageData[] }> = async () => {
  // 1. Define the paths to your image folders
  const thumbnailDir = path.join(process.cwd(), 'public/images/gallery/thumbnails');
...
export default function ProjectsPage({ images }: InferGetStaticPropsType<typeof getStaticProps>) {
  return (
    <>
      <NextSeo
        title="Gallery - My Work" // Updated title
      ...
      <section className="mx-auto mb-40 mt-6 w-full max-w-7xl gap-20 px-6 sm:mt-12 sm:px-14 md:px-20">
        ...
        <div className="my-2">
          <span className="text-sm text-muted-foreground">
            A collection of my work. Click any image to see the full-size version.
          </span>
        </div>
